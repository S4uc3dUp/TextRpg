...
#    print(f"Potions: {len(Hero.potions)}")
...
#def fight(enemy):
#    clear()
#    print(f"{Hero.name} is fighting {enemy.name}")
#    print(f"\n{Hero.name}'s Health: {Hero.health} / {Hero.maxhealth}      {enemy.name}'s Health: {enemy.health} / {enemy.maxhealth}")
#
#    print(f"Potions {len(Hero.potions)} ")
#
#    print("\n1.) Attack")
...
#        input(">> Press enter to continue")
#        fight()
#    elif len(Hero.potions) >= 1:
#        if Hero.health < Hero.maxhealth:
#            potion = Hero.potions.pop()
#            Hero.health += potion.hp_up
...
#    print(f"Enemy dropped {enemy.goldgain} gold!")
#    print(f"You have gained {enemy.expdrop} experience")
#
#    if len(enemy.weapondrop) > 0:
#        if weapon_drop_chance > 0.10:
#            weapon_dropped = random.choice(enemy.weapondrop)
#            Hero.inventory.append(weapon_dropped)
#            print(f"Enemy dropped a {weapon_dropped.name}, added to inventory")
#    
#    if len(enemy.potiondrop) > 0:
#        if potion_drop_chance > 0.10:
#            potion_dropped = random.choice(enemy.potiondrop)
#            Hero.potions.append(potion_dropped)
...
#        print(f"you leveled up to level {Hero.base_level}!")
#
#    input(">> Press enter to continue")
#    start1()
#
